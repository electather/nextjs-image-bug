...
const stylesCss = "test-checkbox{display:block;background:red}test-checkbox input{position:absolute;clip:rect(1px, 1px, 1px, 1px);padding:0;border:0;height:1px;width:1px;overflow:hidden}test-checkbox input:focus+label::before{box-shadow:inset 0px 0px 0px blue darkblue, inset 0px 5000px 0px lightblue}test-checkbox input:disabled+label::before{box-shadow:inset 0px 0px 0px blue gray, inset 0px 5000px 0px lightgray}test-checkbox input:checked:disabled+label::before{background-color:gray}test-checkbox[label]:not([label=\"\"]){padding:12px;min-width:160px}test-checkbox input:checked+label::before{box-shadow:none;background-color:darkblue;background-image:url(\"data:image/svg+xml;base64,\");background-repeat:no-repeat;background-position:center}test-checkbox label{color:darkblue;cursor:pointer;display:flex;align-items:center}test-checkbox label::before{content:\"\";transition:box-shadow 0.3s ease-in-out, background-color 0.3s ease-in-out;box-shadow:inset 0px 0px 0px blue gray;background-color:white;display:inline-block;vertical-align:middle;width:24px;height:24px;margin:0 16px 0 0}test-checkbox label:hover::before{box-shadow:inset 0px 0px 0px blue darkblue, inset 0px 5000px 0px lightblue}test-checkbox label:active::before{box-shadow:inset 0px 0px 0px 2px darkblue, inset 0px 5000px 0px darkblue}";
...
class TestCheckbox {
  ...
  render() {
    ...
    return (hAsync(Host, null, hAsync("input", { type: "checkbox", id: this.name, name: this.name, checked: this.checked, defaultChecked: this.defaultChecked, onChange: this.inputChange, disabled: this.disabled, value: this.value }), hAsync("label", { htmlFor: this.name }, this.label)));
  }
  static get style() { return stylesCss; }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "test-checkbox",
    "$members$": {
      "name": [1],
